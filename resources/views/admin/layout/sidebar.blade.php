...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ URL('/admin') }}">
  ...
  <div class="sidebar-brand-text mx-3">Chat </div>
</a>
...
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseChat" aria-expanded="true" aria-controls="collapseTwo">
    <i class="fas fa-msgs fa-cog"></i>
    <span>Chats</span>
  </a>
  <div id="collapseChat" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="{{ route('admin.chats.index') }}">list</a>
    </div>
  </div>
</li>
